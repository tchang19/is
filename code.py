...
while True:
    ...
    try:
        ...
        if (time.monotonic() - timestamp) >= 10:
            ...
            io.publish("is.moisture1", touch1)
            io.publish("is.motor1", kit.motor1.throttle)

            print("sensor 2 temp: " + str(temp2) + " | moisture: " + str(touch2))
            print("motor status: " + str(kit.motor2.throttle) + "\n")
            io.publish("is.moisture2", touch2)
            io.publish("is.motor2", kit.motor2.throttle)
